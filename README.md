#Caveat
This was downloaded from https://github.com/AndrewJBateman, made minor changes to capitalize env variables.

This repo was created to learn the PERN stack, practice creating a git repo from an existing local repo and deploy it to aws.

The following was Bateman's readme: 
